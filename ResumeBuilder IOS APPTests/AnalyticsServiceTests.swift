...
final class AnalyticsServiceTests: XCTestCase {
    ...
    private static let allAnalyticsEvents: [AnalyticsEvent] = [
        ...
        .recommendationIncluded(surface: "optimization_review", safetyState: "confirmation_required"),
        .recommendationEdited(surface: "optimization_review", safetyState: "confirmation_required"),
        .recommendationSkipped(surface: "optimization_review", safetyState: "safe"),
