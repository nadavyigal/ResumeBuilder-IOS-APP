...
enum BackendConfig {
    ...
    // PostHog analytics — key is loaded from Secrets.swift (gitignored).
    // See Secrets.swift.example for setup. Project ID: 270848.
    static let posthogAPIKey = Secrets.posthogAPIKey
